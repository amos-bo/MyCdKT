...
package com.ktcd.malc.kt_ma_lc.baiduloc.clusterutil.clustering.algo;
...
import com.ktcd.malc.kt_ma_lc.baiduloc.clusterutil.projection.Bounds;
...
import com.ktcd.malc.kt_ma_lc.baiduloc.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.ktcd.malc.kt_ma_lc.baiduloc.clusterutil.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.ktcd.malc.kt_ma_lc.baiduloc.clusterutil.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.ktcd.malc.kt_ma_lc.baiduloc.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.ktcd.malc.kt_ma_lc.baiduloc.clusterutil.clustering.algo
