...
import static com.ktcd.malc.utilslibrary.tools.ConfigUtils.APP_USER_ID;
        ...
        public void run() {
            ...
            if (!xmppManager.isConnected()) {
                ...
                ConnectionConfiguration connConfig = new ConnectionConfiguration(
                        ConfigUtils.getAppDataIP(KtkjMaLcApplication.getInstance()).split(",")[0].replace("http://", ""), xmppPort);
    ...
    private class RegisterTask implements Runnable {
        ...
        public void run() {
            ...
            if (!xmppManager.isRegistered()) {
                final String newUsername = "" + ((LoginBean.DataBean) FileUtils.getObject(KtkjMaLcApplication.getInstance(), "LoginBean.DataBean")).getCpId();
