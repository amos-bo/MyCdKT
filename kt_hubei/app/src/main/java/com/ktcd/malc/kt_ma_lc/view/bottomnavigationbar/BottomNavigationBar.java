package com.ktcd.malc.kt_ma_lc.view.bottomnavigationbar;
...
import com.ktcd.malc.kt_ma_lc.view.bottomnavigationbar.behaviour.BottomNavBarFabBehaviour;
import com.ktcd.malc.kt_ma_lc.view.bottomnavigationbar.behaviour.BottomVerticalScrollBehavior;
import com.ktcd.malc.kt_ma_lc.view.bottomnavigationbar.utils.Utils;
        ...
        if (!mBottomNavigationItems.isEmpty()) {
            ...
            if (mMode == MODE_FIXED) {
                ...
                for (BottomNavigationItem currentItem : mBottomNavigationItems) {
                    ...
                    if (currentItem.getIsMaxIcon()) {
                        int size=(int) getContext().getResources().getDimension(R.dimen.fixed_icon_centermax);
                        bottomNavigationTab.setMaxIcon(size,size);
                    }
...
//                && oldPosition != -1) {
    ...
    /**
     * SingleUploadViewCallback interface invoked when a tab's selection state changes.
     */
