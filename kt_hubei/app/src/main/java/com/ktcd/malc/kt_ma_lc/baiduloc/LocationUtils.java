...
public class LocationUtils {
    ...
    private static android.location.LocationListener listener = new MyLocationListener();
    ...
    public static void addLocationListener(Context context, String provider, long time, float meter, ILocationListener locationListener) {
        ...
        manager.requestLocationUpdates(provider, time, meter, new LocationListener() {
            @Override
