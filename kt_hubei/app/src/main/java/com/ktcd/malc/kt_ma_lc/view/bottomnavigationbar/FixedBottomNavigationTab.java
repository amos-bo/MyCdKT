...
//    }
    ...
    public void setMaxIcon(int w,int h ) {
        LayoutParams ps =(LayoutParams)iconView.getLayoutParams();
        ps.height =h;
        ps.width =w;
        iconView.setLayoutParams(ps);
        labelView.setVisibility(GONE);

        FrameLayout fl=(FrameLayout)iconView.getParent();
        LayoutParams flp =(LayoutParams)fl.getLayoutParams();
        flp.height =h;
        flp.width =h;
        flp.gravity = Gravity.CENTER_VERTICAL;
        fl.setLayoutParams(ps);
