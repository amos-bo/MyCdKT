...
public class ResourcesMapDgPointFregment1 extends BaseFragment {
    ...
    public static ResourcesMapDgPointFregment1 newInstance(String type) {
        ResourcesMapDgPointFregment1 f = new ResourcesMapDgPointFregment1();
        Bundle b = new Bundle();
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        LinearLayout linearLayout = (LinearLayout) inflater.inflate(R.layout.fregment_resourcesmap_dgpoint1, container, false);
        ...
        mRecyclerViewOne = (RecyclerView) linearLayout.findViewById(R.id.recyclerview_partment11);
        mRecyclerViewTwo = (RecyclerView) linearLayout.findViewById(R.id.recyclerview_type12);
        return linearLayout;
    }
